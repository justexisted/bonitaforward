-- Create booking_events table to store customer bookings
-- This table stores appointments made through the Google Calendar booking system
...
-- Service role can insert any booking (for system operations)
