...
import { ProviderImagesManager } from '../components/admin/ProviderImagesManager-2025-10-19'
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (error) {
                                ...
                                setMessage(`Booking ${newStatus === 'confirmed' ? 'confirmed' : 'cancelled'}`)
                              }
                            } catch (err: any) {
                            ...
                            if (confirm('Are you sure you want to delete this booking? This action cannot be undone.')) {
                              try {
                                ...
                                if (error) {
                                  ...
                                  setBookingEvents(prev => prev.filter(b => b.id !== booking.id))
                          ...
                          <button
                            onClick={async () => {
                              ...
                              try {
                                ...
                                // Calendar events refresh handled by CalendarEventsSection component (Step 13)
