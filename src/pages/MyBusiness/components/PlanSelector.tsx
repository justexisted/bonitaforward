 ...
 * Displays the subscription comparison between Free and Featured accounts
 * Only shown when user has no featured listings
 */
...
export function PlanSelector({ onSelectFree, onSelectFeatured }: PlanSelectorProps) {
  return (
