        ...
        {all.length === 0 ? (
          ...
          <div>
            ...
            {(() => {
              ...
              const heroImageFailed = failedImages.has(0)
              return imageUrl && !heroImageFailed ? (
                ...
                <div className="mb-6">
                  ...
                  <div className={`grid gap-3 ${
                    ...
                    {provider.images.slice(1).map((image, index) => {
                      const imageIndex = index + 1 // Actual index in images array (accounting for slice)
                  ...
                  <div className="mt-2 space-y-2">
                    {jobs.map((j) => (
                      <div key={j.id} className="rounded-xl border border-neutral-200 p-3">
                        ...
                        {j.apply_url && <div className="mt-1"><a className="text-xs underline" href={j.apply_url} target="_blank" rel="noopener noreferrer">Apply</a></div>}
                      </div>
                    ))}
                  </div>
                </div>
